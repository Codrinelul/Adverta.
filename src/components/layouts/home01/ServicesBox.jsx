                    ...
                    colleft: [
                        {
                            ...
                            text: 'ARKAN DESIGN provides the right resources and expertise to evaluate concepts through our industry leading Preconstruction Services team.',
                        }
                    ]
                },
                {
                    ...
                    colleft: [
                        {
                            ...
                            icon: 'autora-icon-hat-outline',
                            title: 'DESIGN',
                            text: 'What distinguishes us is quality, appropriate price, implementation time, maintenance and warranty In the end, it is up to you to join our giant group of clients.',
                        }
                    ]
                }
            ]
